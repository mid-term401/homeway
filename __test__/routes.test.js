...
//       .set(
//         "Authorization",
//         "basic " + new Buffer.from(`ib000:0000`, "utf8").toString("base64")
//       );
//     let username = await client.query(
//       "select * from host  where user_name=$1",
//       [resSignIn.body.username]
//     );
//     let token = resSignIn.body.token;
//     // console.log(resSignIn.body);
//     const response = await request
//       .get(`/host/${username.rows[0].id}`)
//       .set("Authorization", "bearer " + new Buffer.from(`${token}`, "utf8"));
//     expect(1).toBe(1);
...
//     let token = resSignIn.body.token;
//     let userData = await client.query("select * from host where user_name=$1", [
//       resSignIn.body.username,
//     ]);
//     const response = await request
//       .put(`/host/${userData.rows[0].id}`)
//       .send({
//         username: "ib000111",
//         password: "0000111",
//         first_name: "samer00",
...
//     // console.log(token);
//     const response = await request
//       .get(`/host/${userData.rows[0].id}/service`)
//       .set("Authorization", "bearer " + new Buffer.from(`${token}`, "utf8"));
//     expect(1).toBe(1);
//     expect(response.status).toBe(200);
//   });
...
//     console.log(resSignIn.body);
//     const response = await request
//       .post(`/host/${userData.rows[0].id}/service`)
//       .send({
//         title: "ibtest2",
...
//       category: "farming",
//     });
//     const resSignInHost = await request
//       .post("/sign_in")
//       .send({
//         username: "ib000",
//         password: "0000",
...
//         "basic " + new Buffer.from(`ib000:0000`, "utf8").toString("base64")
//       );
//     let usernameHost = await client.query(
//       "select * from host where user_name=$1",
//       [resSignInHost.body.username]
//     );
...
//       category: "farming",
//     });
//     const resSignInVolunteer = await request
//       .post("/sign_in")
//       .send({
//         username: "30",
//         password: "0000",
...
//       .set(
//         "Authorization",
//         "basic " + new Buffer.from(`30:0000`, "utf8").toString("base64")
//       );
//     let username = await client.query(
//       "select * from volunteer where user_name=$1",
//       [resSignInVolunteer.body.username]
//     );
//     let HostToken = resSignInHost.body.token;

//     const response = await request
//       .get(`/host/${usernameHost.rows[0]}/volunteer/${username.rows[0].id}`)
//       .set(
//         "Authorization",
//         "bearer " + new Buffer.from(`${HostToken}`, "utf8")
//       );
//     expect(1).toBe(1);
//     expect(response.status).toBe(200);
//   });
...
//     let token = resSignIn.body.token;
//     // console.log(resSignIn.body);
//     const resService = await request
//       .post(`/host/${userData.rows[0].id}/service`)
//       .send({
//         title: "ibtest2",
//         description: "go awwwym",
...
//       })
//       .set("Authorization", "bearer " + new Buffer.from(`${token}`, "utf8"));
//     let serviceData = await client.query(
//       "select * from Service where host_id=$1",
//       [userData.rows[0].id]
//     );
//     // console.log('service',serviceData.rows[0]);

//     const response = await request
//       .put(`/host/${userData.rows[0].id}/service/${serviceData.rows[0].id}`)
//       .send({
...
//     const response = await request
//       .delete(`/host/${userData.rows[0].id}/service/${serviceData.rows[0].id}`)
//       .set("Authorization", "bearer " + new Buffer.from(`${token}`, "utf8"));
//     expect(1).toBe(1);
//     expect(response.status).toBe(302);
//   });
...
//     const response = await request
//       .get(`/volunteer/${username.rows[0].id}/host/${usernameHost.rows[0]}`)
//       .set(
//         "Authorization",
//         "bearer " + new Buffer.from(`${HostToken}`, "utf8")
//       );
